...
@section('content')
           ...
           <div class="slider-area">
                <div class="slider-active-3 owl-carousel slider-hm8 owl-dot-style">
                    ...
                    <div class="slider-height-13 d-flex align-items-start justify-content-start bg-img" style="background-image: url(assets/images/slider-image/sample-27.jpg);">
                        <div class="container">
                            <div class="slider-content-13 slider-animated-1 text-left">
                                <h1 class="animated">
                                    Furniture New Chair<br />
                                    <strong>Minimal Living Room</strong>
                                </h1>
                                <p class="animated">
                    ...
                    <!-- Slider Single Item Start -->
                    <div class="slider-height-13 d-flex align-items-start justify-content-start bg-img" style="background-image: url(assets/images/slider-image/sample-26.jpg);">
                        <div class="container">
                            <div class="slider-content-13 slider-animated-1 text-left">
                                <h1 class="animated">
                                    New Collection<br />
                                    <strong>Fit Your Living Room </strong>
                                </h1>
                                <p class="animated"></p>
                                <a href="shop-4-column.html" class="shop-btn animated">SHOP NOW</a>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="banner-inner banner-box">
                            <a href="shop-4-column.html"><img src="assets/images/banner-image/34.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Banner Area 2 End -->
         ...
         <section class="recent-add-area">
            <div class="container">
                ...
                <div class="recent-product-slider owl-carousel owl-nav-style-3">
                    <!-- Product Single Item -->
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            ...
                            <div class="product-decs text-center">
                                <a class="inner-link" href="shop-4-column.html"><span>Office Cabinets</span></a>
                                <h2><a href="single-product.html" class="product-link">New Design Cabinet..</a></h2>
                        ...
                        <article class="list-product">
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Cabinets</span></a>
                                <h2><a href="single-product.html" class="product-link">Office  Cabinets... </a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/product-image/furniture/10.jpg" alt="" />
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Executive Chair</span></a>
                                <h2><a href="single-product.html" class="product-link">Office relax Chair...</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/product-image/furniture/16.jpg" alt="" />
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Room Furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Bed with Wardrobe</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Coffe Table</span></a>
                                <h2><a href="single-product.html" class="product-link">Classic Coffe Table</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Room Furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Hall furniture..</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Room furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Center Table for you hall..</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/product-image/furniture/22.jpg" alt="" />
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Office Furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Reception Seats...</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    ...
                                    <img class="second-img" src="assets/images/product-image/furniture/13.jpg" alt="" />
                                </a>
                                <div class="add-to-link">
                                    <ul>
                                        <li>
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Cabinets</span></a>
                                <h2><a href="single-product.html" class="product-link">Cabinets...</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Coffe Table</span></a>
                                <h2><a href="single-product.html" class="product-link">Coffe Table</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <div class="product-inner-item">
                        <article class="list-product mb-30px">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/product-image/furniture/14.jpg" alt="" />
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Wardrobes</span></a>
                                <h2><a href="single-product.html" class="product-link">Wardrobes</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                        ...
                        <article class="list-product">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    <img class="first-img" src="assets/images/product-image/furniture/20.jpg" alt="" />
                            ...
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Room Furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Center Table</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
        ...
        <!-- Recent product area end -->
         <!-- Banner Area Start -->
         <div class="banner-3-area mt-70px">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mb-res-xs-30">
                        <div class="banner-wrapper banner-box">
                            <a href="shop-4-column.html"><img src="assets/images/banner-image/35.jpg" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="banner-wrapper banner-box">
                            <a href="shop-4-column.html"><img src="assets/images/banner-image/36.jpg" alt="" /></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="hot-deal-2 owl-carousel owl-nav-style-3">
                    ...
                    <article class="list-product">
                        ...
                        <div class="product-wrapper">
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>High Table</span></a>
                                <h2><a href="single-product.html" class="product-link">Coffie Table</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                    ...
                    <article class="list-product">
                        <div class="hot-item-inner">
                            <div class="img-block">
                                <a href="single-product.html" class="thumbnail">
                                    ...
                                    <img class="second-img" src="assets/images/product-image/furniture/25.jpg" alt="" />
                                </a>
                                <div class="add-to-link">
                                    <ul>
                                        <li>
                        ...
                        <div class="product-wrapper">
                            <div class="product-decs">
                                <a class="inner-link" href="shop-4-column.html"><span>Room Furniture</span></a>
                                <h2><a href="single-product.html" class="product-link">Bed</a></h2>
                                <div class="rating-product">
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
                                    <i class="ion-android-star"></i>
        ...
        <!-- Brand area end -->
       <!-- Feature Area Start -->
       <section class="feature-area mt-40px mb-70px">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <!-- Section Title -->
            ...
            <div class="feature-slider owl-carousel owl-nav-style-3">
                ...
                <div class="feature-slider-item">
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            <a class="inner-link" href="shop-4-column.html"><span>Room Furniture</span></a>
                            <h2><a href="single-product.html" class="product-link">Table</a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                    ...
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            <a class="inner-link" href="shop-4-column.html"><span>Table</span></a>
                            <h2><a href="single-product.html" class="product-link">Table</a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                ...
                <div class="feature-slider-item">
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            <a class="inner-link" href="shop-4-column.html"><span>Office Chair</span></a>
                            <h2><a href="single-product.html" class="product-link">Ofiice Chair</a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                ...
                <div class="feature-slider-item">
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            <a class="inner-link" href="shop-4-column.html"><span>Office Furniture</span></a>
                            <h2><a href="single-product.html" class="product-link"></a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                ...
                <div class="feature-slider-item">
                    ...
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            <a class="inner-link" href="shop-4-column.html"><span>KINDOM BOOKS & STATIONERY</span></a>
                            <h2><a href="single-product.html" class="product-link">...</a></h2>
                            <div class="rating-product">
                                <i class="ion-android-star"></i>
                                <i class="ion-android-star"></i>
                ...
                <div class="feature-slider-item">
                    ...
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            ...
                            <div class="pricing-meta">
                                <ul>
                                    <li class="old-price not-cut">GH18.90</li>
                                </ul>
                            </div>
                        </div>
                    </article>
                ...
                <div class="feature-slider-item">
                    <article class="list-product">
                        ...
                        <div class="product-decs">
                            ...
                            <div class="pricing-meta">
                                <ul>
                                    <li class="old-price">GH18.90</li>
                                    <li class="current-price">GH34.21</li>
                                </ul>
                            </div>
                        </div>
                    </article>
    ...
    <!-- Feature Area End -->
     <!-- Blog area Start -->
     <section class="blog-area mb-60px">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <!-- Section title -->
            ...
            <div class="blog-slider-active owl-carousel owl-nav-style-3">
                ...
                <article class="blog-post">
                    <div class="blog-post-top">
                        <div class="blog-img banner-wrapper">
                            <a href="blog-grid-left-sidebar.html"><img src="assets/images/blog-image/blog-15.jpg" alt="" /></a>
                        </div>
                        <a href="blog-grid-left-sidebar.html" class="blog-meta">Furniture</a>
                    </div>
                    <div class="blog-post-content">
                        <h4 class="blog-post-heading"><a href="blog-single-left-sidebar.html">
                            Furniture for a Sunny Breakfast Nook</a></h4>
                        <p class="blog-text">
                            Now more than ever we appreciate the cheer and serenity of a sunny breakfast nook. Set the tone with a more formal style, choose an urban farmhouse look or create a casual space for family dining. Wrought iron can give your breakfast area an
                             indoor/outdoor feeling, especially if your view includes natural greenery outdoors.
                        </p>
                        <a class="read-more-btn" href="blog-single-left-sidebar.html"> Read More <i class="ion-android-arrow-dropright-circle"></i></a>
                    </div>
                </article>
                ...
                <article class="blog-post">
                    <div class="blog-post-top">
                        <div class="blog-img banner-wrapper">
                            <a href="blog-grid-left-sidebar.html"><img src="assets/images/blog-image/blog.jpg" alt="" /></a>
                        </div>
                        <a href="blog-grid-left-sidebar.html" class="blog-meta">Furniture</a>
                    </div>
                    <div class="blog-post-content">
                        <h4 class="blog-post-heading"><a href="blog-single-left-sidebar.html">Cozy Fireplaces to Take the Chill out of Fall</a></h4>
                        <p class="blog-text">
                            Warm-up fall and winter days with a cozy fireplace that everyone can enjoy. What could be better than getting comfortable after a long day in front of a warming fire? Fireplace options don't stop indoors. To enhance your outdoor patio area, a trendy fire pit 
                            is just what you need when you enjoy the company of family and friends.
                        </p>
                        <a class="read-more-btn" href="blog-single-left-sidebar.html"> Read More <i class="ion-android-arrow-dropright-circle"></i></a>
                    </div>
                </article>
