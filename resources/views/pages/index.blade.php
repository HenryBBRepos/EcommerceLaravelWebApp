                ...
                <div class="recent-product-slider owl-carousel owl-nav-style-3">
                    ...
                    <div class="product-inner-item">
                            ...
                            <article class="list-product mb-30px">
                                <div class="img-block">
                                    <a href="{{route('product_detail',[ $product->id])}}" class="thumbnail">
                                        <img class="first-img" src="{{asset('storage/'.$product->product_image)}}" alt="" />
                                        <img class="second-img" src="{{asset('storage/'.$product->product_image)}}" alt="" />
                                    </a>
                                    <div class="add-to-link">
                                        <ul>
                                            <li>
                                                <a href="{{url('add-to-cart/'.$product->id)}}" title="Add to Cart"><i class="ion-bag"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" title="wishlist"><i class="ion-android-favorite-outline"></i></a>
                                            </li>
                                            <li>
                                                <a href="#" title="Compare"><i class="ion-ios-shuffle-strong"></i></a>
                                            </li>
                                            <!-- <li>
